...
public class Constants {
    ...
    public static final String JAR_NAME = "bigdata2016-minskq3-task2-1.0.3-jar-with-dependencies.jar";
    public static final String APP_NAME = "bigdata2016-minskq3-task2-1.0.3";
